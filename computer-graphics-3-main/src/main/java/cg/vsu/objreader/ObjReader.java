...
public class ObjReader {
	...
	public static Model read(String fileContent) throws FileNotFoundException {
		Model result = new Model();


		int lineInd = 0;
		Scanner scanner = new Scanner(new FileReader(fileContent));
